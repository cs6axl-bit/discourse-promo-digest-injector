...
after_initialize do
  ...
  module ::PromoDigestSettings
    ...
    def self.push_hardsale_campaign_enabled?
      return false unless SiteSetting.respond_to?(:promo_digest_injector_push_hardsale_campaign_enabled)
      SiteSetting.promo_digest_injector_push_hardsale_campaign_enabled == true
    rescue
      false
    end

    def self.push_hardsale_campaign_percent
      return 30 unless SiteSetting.respond_to?(:promo_digest_injector_push_hardsale_campaign_percent)
      v = SiteSetting.promo_digest_injector_push_hardsale_campaign_percent.to_i
      v = 0 if v < 0
      v = 100 if v > 100
      v
    rescue
  ...
  module ::PromoDigestInjector
    ...
    def self.empty_topic_relation_for_digest
      Topic.where("1=0")
    rescue
      Topic.none
    end

    def self.try_replace_push_with_hardsale_campaign(user, source_topic_id)
      enabled = ::PromoDigestSettings.push_hardsale_campaign_enabled?
      percent = ::PromoDigestSettings.push_hardsale_campaign_percent
      coinflip_passed = false
      result = nil
      ...
      coinflip_passed = (percent.to_i >= 100) || (rand(100) < percent.to_i)
      unless coinflip_passed
        return {
          enabled: enabled,
          percent: percent,
          attempted: true,
      ...
      unless defined?(::DigestCampaigns::AiwriteHardsaleService)
        return {
          enabled: enabled,
          percent: percent,
          attempted: true,
          coinflip_passed: true,
          replaced_regular_digest: false,
          reason: "digest_campaigns_service_missing"
        }
      end

      result = ::DigestCampaigns::AiwriteHardsaleService.replace_push_digest_with_aiwrite_campaign(
        user: user,
...

      {
        ...
        attempted: true,
        coinflip_passed: true,
        replaced_regular_digest: result[:ok] == true,
        reason: (result[:ok] == true ? "replaced" : (result[:reason].presence || "not_replaced")),
        result: result || {}
      }
    rescue => e
      {
        ...
        percent: percent,
        attempted: true,
        coinflip_passed: coinflip_passed,
        replaced_regular_digest: false,
        reason: "error",
            ...
            if push_apply_percent.to_i <= 0
              ...
              if !push_coinflip_passed
                ...
                if push_selected_topic_id.to_i > 0
                  push_applied = true
                  push_hardsale_campaign = try_replace_push_with_hardsale_campaign(user, push_selected_topic_id.to_i)

                  original_ids = original_relation.limit(limit).pluck(:id).map(&:to_i).reject(&:zero?)

                  if push_hardsale_campaign[:replaced_regular_digest]
                    Thread.current[:promo_digest_replaced_by_hardsale_campaign] = push_hardsale_campaign
                    persist_pushed_topic_history(user, push_selected_topic_id.to_i)
                    final_ids = []
                  else
                  ...
                  enqueue_summary_post(
                    ...
                    push_hardsale_campaign_enabled: push_hardsale_campaign[:enabled],
                    push_hardsale_campaign_percent: push_hardsale_campaign[:percent],
                    push_hardsale_campaign_attempted: push_hardsale_campaign[:attempted],
                    push_hardsale_campaign_coinflip_passed: push_hardsale_campaign[:coinflip_passed],
                    push_hardsale_campaign_replaced_regular_digest: push_hardsale_campaign[:replaced_regular_digest],
                    push_hardsale_campaign_reason: push_hardsale_campaign[:reason],
                    push_hardsale_campaign_topic_id: push_selected_topic_id,
                    push_hardsale_campaign_result: push_hardsale_campaign[:result],
                    push_hardsale_campaign_aiwrite_id: push_hardsale_campaign.dig(:result, :aiwrite_id),
                    push_hardsale_campaign_campaign_id: push_hardsale_campaign.dig(:result, :campaign_id),
                    push_hardsale_campaign_campaign_key: push_hardsale_campaign.dig(:result, :campaign_key),
                    push_hardsale_campaign_queue_id: push_hardsale_campaign.dig(:result, :queue_id),
                    push_hardsale_campaign_queue_status: push_hardsale_campaign.dig(:result, :queue_status)
                  )

                  return push_hardsale_campaign[:replaced_regular_digest] ? empty_topic_relation_for_digest : build_ordered_relation(user, final_ids)
                end
              end
            end
          end
    ...
    def self.enqueue_summary_post(
      ...
      push_hardsale_campaign_enabled:,
      push_hardsale_campaign_percent:,
      push_hardsale_campaign_attempted:,
      push_hardsale_campaign_coinflip_passed:,
      push_hardsale_campaign_replaced_regular_digest:,
      push_hardsale_campaign_reason:,
      push_hardsale_campaign_topic_id:,
      push_hardsale_campaign_result:,
      push_hardsale_campaign_aiwrite_id:,
      push_hardsale_campaign_campaign_id:,
      push_hardsale_campaign_campaign_key:,
      push_hardsale_campaign_queue_id:,
      push_hardsale_campaign_queue_status:
    )
      ...
      payload = {
        ...
        debug: {
          ...
          push_hardsale_campaign: {
            enabled: push_hardsale_campaign_enabled,
            percent: push_hardsale_campaign_percent,
            attempted: push_hardsale_campaign_attempted,
            coinflip_passed: push_hardsale_campaign_coinflip_passed,
            replaced_regular_digest: push_hardsale_campaign_replaced_regular_digest,
            reason: push_hardsale_campaign_reason,
            topic_id: push_hardsale_campaign_topic_id,
            source_topic_id: (push_hardsale_campaign_result.is_a?(Hash) ? (push_hardsale_campaign_result[:source_topic_id] || push_hardsale_campaign_result['source_topic_id']) : nil),
            aiwrite_id: push_hardsale_campaign_aiwrite_id,
            campaign_id: push_hardsale_campaign_campaign_id,
            campaign_key: push_hardsale_campaign_campaign_key,
            queue_id: push_hardsale_campaign_queue_id,
            queue_status: push_hardsale_campaign_queue_status,
            result: push_hardsale_campaign_result
          },
